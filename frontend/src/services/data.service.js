...
const baseUrl =
    process.env.NODE_ENV === 'development' ? 'http://localhost:5000/api' : 'https://suggestit.chalmers.it/api';
...
export const loginRedirect = () =>
    axios
        ...
        .then((res) =>
            window.location.replace(`https://ldap-auth.chalmers.it/authenticate?client_id=${res.data.client_id}`)
        )
    ...
    new Promise((resolve, reject) => {
        ...
        axios
            ...
            .catch((err) => {
                ...
                console.log('You must be a member of P.R.I.T. to read suggestions');
