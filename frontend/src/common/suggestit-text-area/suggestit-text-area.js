/*
    Copied from cthit/react-digit-components
    This component will be deprecated when DigitTextArea has been updated
 */
import PropTypes from "prop-types";
import React from "react";
import { TextField } from "@material-ui/core";

const SuggestItTextArea = ({
    value,
    onChange,
    onBlur,
    upperLabel,
...
SuggestItTextArea.displayName = "SuggestItTextArea";
SuggestItTextArea.propTypes = {
    ...
    /** The onBlur event occurs when SuggestItTextArea loses focus. */
...
SuggestItTextArea.defaultProps = {
    onBlur: () => {},
    upperLabel: "",
    lowerLabel: "",
    name: "",
...
export default SuggestItTextArea;
